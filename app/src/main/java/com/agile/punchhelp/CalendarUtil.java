...
public class CalendarUtil {
    ...
    public static String CALENDARS_NAME = "PuncherHelper";
    public static String CALENDARS_ACCOUNT_NAME = "PuncherHelper";
    public static String CALENDARS_ACCOUNT_TYPE = "com.agile.punchhelp";
    public static String CALENDARS_DISPLAY_NAME = "PuncherHelper";
    ...
    public static boolean insertCalendarEvent(Context context, String title, String description,
        ...
        // 如果结束时间为零，使用起始时间+120分钟
        if (endTimeMillis == 0) {
            endTimeMillis = beginTimeMillis + 120 * 60 * 1000;
        }
